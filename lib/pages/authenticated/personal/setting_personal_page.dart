      ...
      child: Container(
          ...
          child: Column(
              children: [
                  ...
                  child: const Row(
                    children: [
                      Padding(
                        ...
                        child: Icon(Icons.edit_outlined, color: Colors.black, size: 34, )
                      ),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text('Chỉnh sửa trang cá nhân', style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.w400),),
                            ),
                          ],
                        )
                      ),
                ...
                const SizedBox(height: 1.0, width: double.infinity, 
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      color: Color(0xFFc9ccd1)
                    ),
                ...
                TextButton(
                  ...
                  child: const Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.fromLTRB(5, 0, 10, 0),
                        child: Icon(Icons.search_outlined, color: Colors.black, size: 34, )
                      ),
                      Expanded(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Liên kết đến trang cá nhân của bạn', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w700),),
                      const SizedBox(height: 10,),
                      const Text('Liên kết của riêng bạn trên Facebook.', style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w400),),
