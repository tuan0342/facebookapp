...
class FirstEditName extends StatefulWidget {
  const FirstEditName({super.key});

  @override
  State<FirstEditName> createState() => _FirstEditNameState();
}

class _FirstEditNameState extends State<FirstEditName> {
          ...
          child: Container(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Đổi tên lần đầu', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w600)),
                    const Padding(
                    ...
                    Container(
                        ...
                        child: RichText(
                          text: const TextSpan(
                            ...
                            children: <TextSpan>[
                            TextSpan(
                              text: 'Bạn phải đổi tên lần đầu mới được phép sử dụng các dịch vụ của Anti Facebook. ',
