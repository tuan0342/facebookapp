...
class FullScreenVideoPostItem extends StatefulWidget {
  ...
  @override
  _FullScreenVideoPostItem createState() => _FullScreenVideoPostItem();
}

class _FullScreenVideoPostItem extends State<FullScreenVideoPostItem> {
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FullScreenVideoPlayer(videoPost: widget.videoPost, isInView: widget.isInView, index: widget.index, videoUrl: widget.videoPost.video.url, vController: widget.controller,),
              // AspectRatio(
