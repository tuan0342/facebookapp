                  ...
                  MyFilledButton(
                    ...
                    cbFunction: (){
                      if(firstNameController.text.isEmpty && middleNameController.text.isEmpty && lastNameController.text.isEmpty) {
                        showSnackBar(context: context, msg: "Vui lòng nhập thông tin!");
                      } else {
                        final regex = RegExp(r'\s+');
                        String fullName = '${firstNameController.text.trim()} ${middleNameController.text.trim()} ${lastNameController.text.trim()}'.trim().replaceAll(regex, ' ');
                        debugPrint('check ${fullName}');
                        UserService().changeUsernameOrAvt(context: context, fullName: fullName, avatar: '');
                      }
                    },
                    style: ButtonStyle(
                      minimumSize:
