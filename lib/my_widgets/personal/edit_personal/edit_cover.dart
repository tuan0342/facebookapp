...
class EditCover extends StatefulWidget {
  ...
  const EditCover({super.key, required this.profile, required this.fileCover, 
        required this.contextPage, required this.changeFileCover});
                ...
                decoration: widget.fileCover.path == '' 
                  ? BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                      ...
                      shape: BoxShape.rectangle,
                      image: DecorationImage(image: FileImage(widget.fileCover), fit: BoxFit.cover),
                      borderRadius: BorderRadius.circular(10),
                    ),
              ),
